...
## ⚠️ Volume correction
Different AVR brands use different volume scales. Specify the maximum value of your AVR’s volume scale in the app settings. This will allow the app to convert it to a normalized percentage scale of 0–100%.
